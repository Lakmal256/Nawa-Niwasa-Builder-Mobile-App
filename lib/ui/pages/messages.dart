        ...
        children: [
          ...
          Padding(
            ...
            child: AppSearchBar(
              ...
              // hintText: 'SEARCH MY MESSAGES',
              hintText: AppLocalizations.of(context)!.nN_1028.toUpperCase(),
            ),
          ),
              ...
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  var items = (snapshot.data ?? [])
                      .reversed
                      .where((item) =>
                          (item.lastMessage?.interlocutorName?.toLowerCase() ?? "").contains(filterValue.toLowerCase()))
                      .toList();
